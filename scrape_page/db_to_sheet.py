...
for i in total_result:
    ...
    today_count = products.count_documents({'$and': [{'city': city_name}, {
                                           'cate': cate_name}, {'created_date': {'$gte': today}}]})
    three_days_count = products.count_documents({'$and': [{'city': city_name}, {
                                                'cate': cate_name}, {'created_date': {'$gte': three_days_ago}}]})
